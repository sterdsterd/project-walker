    ...
    protected void onHandleIntent(Intent intent) {
        if (ActivityRecognitionResult.hasResult(intent)) {
            ...
            PreferenceManager.getDefaultSharedPreferences(this)
                    .edit()
                    .putString(net.sterdsterd.walker.MainActivityKt.DETECTED_ACTIVITY,
                            detectedActivitiesToJson(detectedActivities))
                    .apply();

            DetectedActivity mostProbableActivity
                    = result.getMostProbableActivity();
            int activityTypeCode = mostProbableActivity.getType();
            String activityType = getActivityString(this, activityTypeCode);
            PreferenceManager.getDefaultSharedPreferences(this)
                    .edit()
                    .putString(net.sterdsterd.walker.MainActivityKt.ACTIVITY_TYPE,
                            activityType)
                    .apply();
